...
func getNPMPod(input *Input, npmCache *npm.NPMCache) (*npm.NpmPod, error) {
	switch input.Type {
	case PODNAME:
...
func matchKEYVALUELABELOFNAMESPACE(pod *npm.NpmPod, npmCache *npm.NPMCache, setInfo *pb.RuleResponse_SetInfo) bool {
...
func matchKEYLABELOFNAMESPACE(pod *npm.NpmPod, npmCache *npm.NPMCache, setInfo *pb.RuleResponse_SetInfo) bool {
	srcNamespace := util.NamespacePrefix + pod.Namespace
